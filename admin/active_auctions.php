...
<head>
    ...
    <title>Active Auctions - Luxury Auction Admin</title>
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="search-container animated">
            <input type="text" id="searchInput" placeholder="Search by title or seller" aria-label="Search active auctions">
        </div>
        
        <?php if (empty($active_auctions)): ?>
            <p class="animated">No active auctions at this time.</p>
        <?php else: ?>
